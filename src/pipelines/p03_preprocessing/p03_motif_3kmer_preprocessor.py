...
class Motif_3kmer_Preprocess(preprocessor_worker):
    ...
    def get_3kmer_motif_triads_fast(self, chunk: pd.DataFrame, col: str):
        ...
        vectorizer = CountVectorizer(analyzer='char', ngram_range=(3, 3), vocabulary=constants.KMER3_NAMES, lowercase=False)
        ...
        triad_df = pd.DataFrame(
            ...
            columns=[f"{col}_3kmer_{t}" for t in constants.KMER3_NAMES],
            index=chunk.index
        )

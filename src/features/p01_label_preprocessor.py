...
class Label_Preprocess(preprocessor_worker):
    def __init__(self, is_testing_data: bool = True) -> None:
        ...
        self.translation_array = [
              (constants_labels.BINDING_YES_LABEL,    self.encoder.encode_binding_yes_status)
            , (constants_labels.BINDING_NOT_LABEL,    self.encoder.encode_binding_not_status)
            , (constants_labels.BINDING_UNK_LABEL,    self.encoder.encode_binding_unk_status)
            , (constants_labels.NEUTRAL_YES_LABEL,    self.encoder.encode_neutral_yes_status)
            , (constants_labels.NEUTRAL_NOT_LABEL,    self.encoder.encode_neutral_not_status)
            , (constants_labels.NEUTRAL_UNK_LABEL,    self.encoder.encode_neutral_unk_status)
